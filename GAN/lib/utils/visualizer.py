...
def main():
  from X2CT.GAN.lib.dataset.data_augmentation import CT_Data_Augmentation, Xray_Data_Augmentation
  test_file = r'E:\x2ct\CVPR_dataset\data\LIDC-HDF5-256\LIDC-IDRI-0001.20000101.3000566.1\ct_xray_data.h5'
  import h5py

  from X2CT.GAN.lib.config.config import cfg, merge_dict_and_yaml
