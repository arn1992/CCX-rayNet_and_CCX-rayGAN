...
def get_model(dataset_name):
  ...
  #   from .singl  from .singleView_GAN_xray import CTGAN
  #   #   return CTGANeView_xray import CTEncoderDecoder
  #   return CTEncoderDecoder
  # elif dataset_name == 'SingleViewEDGAN':

  # if dataset_name == 'SingleViewEDGAN2D':
  #   from .singleView_GAN_xray2DD import CTGAN
  #   return CTGAN
  if dataset_name == 'SingleViewEncoderDecoder':
