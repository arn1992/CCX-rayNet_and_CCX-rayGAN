...
# from X2CT.GAN.lib.utils import html
from X2CT.GAN.lib.utils.visualizer import tensor_back_to_unnormalization, save_images, tensor_back_to_unMinMax
#from lib.utils.metrics_np import MAE, MSE, Peak_Signal_to_Noise_Rate, Structural_Similarity, Cosine_Similarity
from X2CT.GAN.lib.utils import ct as CT
import copy
import tqdm
import torch
import numpy as np
...
def parse_args():
  ...
  parse.add_argument('--dataset_class', type=str, default='align_ct_xray', dest='dataset_class',
  ...
  parse.add_argument('--load_path', type=str, default='./save_models/singleView_ED3D/checkpoint', dest='load_path',
  ...
  parse.add_argument('--how_many', type=int, dest='how_many', default=50,
                     help='if specified, print more debugging information')
  parse.add_argument('--resultdir', type=str, default='./save_visual', dest='resultdir',
